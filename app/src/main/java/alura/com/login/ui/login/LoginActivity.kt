...
import alura.com.login.databinding.ActivityLoginBinding //activity login + binding
//binding substitui find view by id
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginViewModel = ViewModelProvider(this, LoginViewModelFactory())
                .get(LoginViewModel::class.java) //Associa o viewModel desta activity

        //Observador do login view model
        loginViewModel.loginFormState.observe(this@LoginActivity, Observer {
            val loginState = it ?: return@Observer

            // Não deixa clicar em login, a menos que o login e senha sejam validos
    ...
    /**
     * Atualizar interface do usuário  com o UsuáNrio
     */
    ...
    /**
     * Função para mostrar que a tela de login falhou
     */
